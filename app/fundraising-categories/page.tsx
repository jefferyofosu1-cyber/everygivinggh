...
const CATEGORIES = [
  ...
  { name:'Community', emoji:'🏘', slug:'community', desc:'Local projects, neighbourhood improvements, and community welfare initiatives.', img:'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=400&q=80&auto=format&fit=crop', examples:['Borehole project','Street lighting','Community centre','Clean-up campaign'] },
  ...
  { name:'Wishes', emoji:'🌟', slug:'wishes', desc:'Life-changing wishes, personal dreams, and meaningful milestones.', img:'https://images.unsplash.com/photo-1513689125086-6c432170e843?w=400&q=80&auto=format&fit=crop', examples:['Dream birthday','First home','Life bucket list','Special anniversary'] },
  ...
  { name:'Other', emoji:'💚', slug:'other', desc:"Doesn't fit a category? Start your campaign and describe your cause — we'll find a place for it.", img:'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&q=80&auto=format&fit=crop', examples:['Unique causes','Personal projects','Creative endeavours','Custom campaigns'] },
]
      ...
      <main>
        <section className="bg-navy py-16 px-5 relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/50 text-base max-w-xl mx-auto leading-relaxed">EveryGiving supports 17 fundraising categories. Whatever your cause — there is a place for it here.</p>
          </div>
        </section>
