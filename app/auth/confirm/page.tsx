...
function ConfirmContent() {
  ...
  useEffect(() => {
    if (!error) {
      // Auto-redirect to create after 3 seconds
    ...
    return (
      <div className="min-h-screen bg-navy flex items-center justify-center px-5">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-white/50 text-sm mb-8">The confirmation link may have expired. Try signing up again.</p>
  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center px-5">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-white/30 text-xs mb-8">Taking you to start your campaign in a moment…</p>

        {/* Progress bar */}
        <div className="w-48 h-1 bg-white/10 rounded-full mx-auto mb-8 overflow-hidden">
          <div className="h-full bg-primary rounded-full animate-[grow_3s_ease-in-out_forwards]" style={{ width: '0%', animation: 'width 3s ease forwards' }} />
        </div>
