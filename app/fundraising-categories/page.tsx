...
const CATEGORIES = [
  ...
  { name: 'Emergency', emoji: '🆘', slug: 'emergency', colour: 'bg-orange-50 border-orange-100 text-orange-600', desc: 'Urgent crises: fire, floods, accidents, and unexpected disasters.', examples: ['House fire', 'Flood damage', 'Accident recovery', 'Sudden death'] },
  ...
  { name: 'Travel', emoji: '✈️', slug: 'travel', colour: 'bg-indigo-50 border-indigo-100 text-indigo-600', desc: 'Travel costs for medical treatment, education, work, or humanitarian missions.', examples: ['Medical trip abroad', 'Study abroad fees', 'Mission trip travel', 'Repatriation'] },
