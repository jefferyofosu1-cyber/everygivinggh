...
const SAMPLE_CAMPAIGNS = [
  {
    ...
    coverEmoji: 'Ìø•', coverGradient: 'linear-gradient(135deg,#1B4332,#52B788)',
  },
  {
    ...
    coverEmoji: '‚õ™', coverGradient: 'linear-gradient(135deg,#2C3E50,#4A6FA5)',
  },
  {
    ...
    isUrgent: true, isFunded: false, isDiasporaFriendly: true,
    coverEmoji: 'Ì≥ö', coverGradient: 'linear-gradient(135deg,#5C3317,#A0522D)',
  },
  {
    id: '4', slug: 'kofi-bone-tumour', category: 'medical',
    title: 'Surgery for Kofi ‚Äî bone tumour removal at 37 Military Hospital',
    ...
    coverEmoji: 'Ìπ∫', coverGradient: 'linear-gradient(135deg,#3D0C02,#9B2335)',
  },
  {
    id: '5', slug: 'nkoranza-borehole', category: 'community',
    title: 'Borehole for Nkoranza North ‚Äî clean water for 400 families',
    ...
    coverEmoji: 'Ì≤ß', coverGradient: 'linear-gradient(135deg,#014F86,#2196F3)',
  },
  {
    id: '6', slug: 'maame-efua-funeral', category: 'funeral',
    title: 'Funeral expenses for Maame Efua ‚Äî community support needed',
    ...
    coverEmoji: 'ÌµäÔ∏è', coverGradient: 'linear-gradient(135deg,#2D2D2D,#6D6D6D)',
  },
  {
    ...
    isUrgent: false, isFunded: false, isDiasporaFriendly: true,
    coverEmoji: 'Ìø†', coverGradient: 'linear-gradient(135deg,#7B3F00,#C68642)',
  },
  {
    ...
    isUrgent: false, isFunded: false, isDiasporaFriendly: false,
    coverEmoji: '‚úèÔ∏è', coverGradient: 'linear-gradient(135deg,#1A1A2E,#16213E)',
  },
  {
    id: '9', slug: 'pastor-emmanuel-dialysis', category: 'medical',
    title: 'Dialysis funding for Pastor Emmanuel ‚Äî 3 months of treatment',
    organiserName: 'Grace Assembly Takoradi', location: 'Takoradi',
    raisedGHS: 11000, goalGHS: 18000, donorCount: 104, daysLeft: 9,
    isUrgent: true, isFunded: false, isDiasporaFriendly: true,
    coverEmoji: 'Ì≤ä', coverGradient: 'linear-gradient(135deg,#0D3B00,#2D6A0D)',
  },
];
          ...
          <div style={{ paddingTop: 40, paddingBottom: 0 }}>
            ...
            <div style={{ position: 'relative', maxWidth: 600, marginBottom: 24 }}>
              ...
              <input
                ...
                placeholder="Search campaigns, names, causes‚Ä¶"
              ...
              />
              {query && (
                <button onClick={clearAll} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'rgba(255,255,255,0.15)', border: 'none', color: '#fff', width: 22, height: 22, borderRadius: '50%', cursor: 'pointer', fontSize: 14, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>√ó</button>
              )}
            </div>
          </div>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 28px 60px' }}>
        {filtered.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '60px 20px', background: '#fff', border: '1px solid #E8E4DC', borderRadius: 14 }}>
            <div style={{ fontSize: 40, marginBottom: 14, opacity: 0.4 }}>Ì¥ç</div>
        ...
        {filtered.length > visibleCount && (
          <div style={{ textAlign: 'center', marginTop: 28 }}>
            ...
            >
              Load more ‚Äî {filtered.length - visibleCount} remaining
            </button>
          </div>
        )}
      </div>
...
console.log('Written app/page.tsx ‚Äî', fs.statSync(outPath).size, 'bytes');
