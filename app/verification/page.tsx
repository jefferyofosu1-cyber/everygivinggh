...
export const metadata = {
  title: 'Verification levels · Every Giving',
  description:
    'Understand Basic, Standard, and Premium verification for Every Giving campaigns.',
}
  ...
  const levels = [
    {
      ...
      emoji: '🟢',
      description:
        'ID upload only. Great for smaller campaigns with friends and family.',
      idealFor: 'Goals up to ₵5,000',
      checks: ['Ghana Card or accepted ID uploaded', 'Manual review of ID'],
    },
    {
      name: 'Standard',
      badge: '✓ Verified',
      emoji: '✅',
      description:
        'ID + selfie review. Recommended for most personal and medical campaigns.',
      idealFor: '₵5,000 - ₵10,000',
      checks: [
        'ID document review',
        'Selfie matched to ID',
        'Basic fraud checks',
      ],
    },
    {
      ...
      emoji: '⭐',
      description:
        'Deep verification for high-impact or community campaigns.',
      idealFor: '₵10,000 and above',
      checks: [
        'All Standard checks',
        'Supporting documents (hospital letters, invoices, etc.)',
        ...
        <section className="bg-navy text-white py-16">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-white/60 text-sm md:text-base max-w-2xl mx-auto">
              Every campaign on Every Giving is reviewed. Higher verification
              levels give donors more confidence and unlock higher goals.
            </p>
          </div>
        </section>
            ...
            {levels.map((level) => (
              ...
              >
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <div>
                    <div className="font-nunito font-black text-navy text-lg">
                      {level.name}
                    </div>
                    <div className="text-xs font-bold px-2 py-0.5 rounded-full bg-gray-100 text-gray-600 inline-block mt-1">
                      {level.badge}
                    </div>
                  </div>
                </div>
