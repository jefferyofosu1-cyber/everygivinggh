...
export const metadata = {
  title: 'How Every Giving works',
  description:
    'Learn how to start a fundraiser, share your story, and receive donations on Every Giving.',
}
  ...
  const steps = [
    {
      ...
      emoji: '✍️',
      body: 'Tell your story, set a goal amount, and choose the right category. Clear, honest stories raise the most.',
    },
    {
      title: 'Verify your identity',
      emoji: '🪪',
      body: 'Upload your Ghana Card or accepted ID so donors know you are real. Higher verification unlocks higher goals.',
    },
    {
      title: 'Share everywhere',
      emoji: '📱',
      body: 'Share your campaign link across WhatsApp, SMS, and social media. Friends and family can donate in a few taps.',
    },
    {
      title: 'Receive donations',
      emoji: '💚',
      body: 'Donations are held securely and released to your MoMo wallet as you hit agreed milestones.',
    },
  ]
      ...
      <main className="bg-gray-50 min-h-screen">
        <section className="bg-white py-16 border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h1 className="font-nunito font-black text-navy text-3xl md:text-4xl mb-3">
              How it works
            </h1>
            <p className="text-gray-500 text-sm md:text-base max-w-2xl mx-auto">
              Every Giving makes it simple and safe to raise money for medical
              bills, school fees, churches, and community projects in Ghana.
            </p>
          </div>
        </section>
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-6 grid md:grid-cols-2 gap-8">
            {steps.map((s, i) => (
              ...
              >
                <div className="w-10 h-10 rounded-2xl bg-primary-light flex items-center justify-center text-xl">
                  {s.emoji}
                </div>
                <div>
