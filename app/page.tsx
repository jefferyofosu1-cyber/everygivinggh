      ...
      <main>
        ...
        <section className="max-w-6xl mx-auto px-5 py-16 grid md:grid-cols-2 gap-14 items-center">
          <div className="animate-fadeUp">
            ...
            <p className="text-xs text-gray-400 flex items-center gap-1">🔒 No platform fee · Verified campaigns · Instant MoMo payout</p>
          </div>
          ...
          <div className="hidden md:grid grid-cols-2 gap-4">
            {[
              ...
              { label: 'Platform fee', value: '0%', color: 'bg-amber-50', icon: '🎁' },
        ...
        <div className="bg-navy">
          <div className="max-w-6xl mx-auto px-5 grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
            {[
              ...
              { icon: '💸', title: 'Zero Platform Fee', desc: '100% of donations reach the campaign. You keep everything.' },
            ].map((item, i) => (
        ...
        <section className="bg-gradient-to-br from-primary-dark to-primary py-20 text-center">
          <div className="max-w-xl mx-auto px-5">
            ...
            <p className="text-white/50 text-xs mt-5">🔒 Ghana Card verified · 0% platform fee · Instant MoMo payout</p>
          </div>
        </section>
      </main>
      <Footer />
