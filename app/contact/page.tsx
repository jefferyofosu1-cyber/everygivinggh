            ...
            <div className="grid md:grid-cols-5 gap-8">
              ...
              <div className="md:col-span-2 flex flex-col gap-4">
                ...
                <div className="rounded-2xl p-6 shadow-sm border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
                  ...
                  <div className="text-xs mt-2 leading-relaxed" style={{ color: 'var(--text-muted)' }}>We reply within 2 business days. Urgent payout issues are prioritised for same-day resolution.</div>
                </div>
                ...
                <div className="rounded-2xl p-6 shadow-sm border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      { type: 'Payout issues', time: 'Same day', color: 'var(--primary)' },
                      { type: 'Verification help', time: '24 hours', color: 'var(--primary)' },
                      { type: 'General questions', time: '2 business days', color: 'var(--text-muted)' },
                      { type: 'Press enquiries', time: '3 business days', color: 'var(--text-muted)' },
                    ].map((item, i) => (
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      ...
                      <Link key={i} href={link.href}
                        className="flex items-center justify-between text-sm text-[var(--text-muted)] hover:text-primary transition-colors py-1 group">
              ...
              <div className="md:col-span-3">
                <div className="rounded-2xl p-7 shadow-sm border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
                  ...
                  {formState === 'sent' ? (
                    <div className="text-center py-10">
                      ...
                      <p className="text-sm mb-6 max-w-xs mx-auto" style={{ color: 'var(--text-muted)' }}>Your email app should have opened with your message ready. We will respond within 2 business days.</p>
                    ...
                    <>
                      ...
                      <p className="text-sm mb-6" style={{ color: 'var(--text-muted)' }}>Fill in the form and we'll get back to you.</p>
                      ...
                      <div className="flex flex-col gap-4">
                          ...
                          <div className="grid grid-cols-1 gap-2">
                            {TOPICS.map(t => (
                              <button key={t} onClick={() => setTopic(t)}
                                className={`text-left text-sm px-4 py-3 rounded-xl border-2 transition-all font-medium ${topic === t ? 'border-primary bg-primary-light text-primary-dark' : 'border-[var(--border)] text-[var(--text-muted)] bg-[var(--surface-alt)]'}`}>
                                {t}
                              </button>
                            ))}
                          </div>
                        ...
                        <button
                          ...
                          style={(!name || !email || !message || !topic) ? { background: 'var(--surface-alt)', color: 'var(--text-muted)' } : {}}>
